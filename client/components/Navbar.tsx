...
const Navbar = () => {
  return (
    <div className="flex justify-between items-center px-5 py-2 h-30 bg-gray-100">
      <Link to='/' className= 'font-bold text-3xl hover:cursor-pointer'>Blogify</Link>
      <div className="flex justify-center items-center w-1/2">
        ...
        <div className='flex justify-around items-center w-1/3 py-3'>
          ...
          <Link to='/write' className='font-semibold rounded-full border-black border p-1 h-12 w-12 flex flex-center items-center hover:border-teal-600 hover:shadow-lg hover:shadow-cyan-500/50 hover:text-teal-600 hover:cursor-pointer'>Write</Link>
        </div>
      </div>
    </div>
  );
